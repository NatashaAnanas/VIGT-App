...
final class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        viewControllers = [
            setupTabBarItem(for: MainViewController(), title: "Главная", imageName: "1.square.fill", tag: 0),
            ...
            setupTabBarItem(for: ProfileViewController(), title: "Профиль", imageName: "5.square.fill", tag: 4)
        ]
    }
